...
class TechnoRVAdapter( private val listener:TechnoNewsItemClicked , private val btnlistener: ShareBtnClicked) : RecyclerView.Adapter<TechnoRVAdapter.TechnoViewHolder>(){

    private  val arrayList : ArrayList<NewsDataClass> = ArrayList()

    class TechnoViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
...
//        val cardView: CardView = itemView.findViewById(R.id.cardView)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TechnoViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_card,parent,false)
        val viewHolder= TechnoViewHolder(view)
    ...
    override fun onBindViewHolder(holder: TechnoViewHolder, position: Int) {
...
interface TechnoNewsItemClicked {

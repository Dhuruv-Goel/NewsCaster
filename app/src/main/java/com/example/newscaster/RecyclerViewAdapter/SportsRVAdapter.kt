...
import com.example.newscaster.Fragments.SportsFragment
import com.example.newscaster.R

class SportsRVAdapter( private val listener: SportsFragment, private val btnlistener: ShareBtnClicked) : RecyclerView.Adapter<SportsRVAdapter.SportsViewHolder>(){
...
//        val cardView: CardView = itemView.findViewById(R.id.cardView)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SportsViewHolder {
        ...
        val viewHolder= SportsViewHolder(view)
...
interface SportsNewsItemClicked {

...
class HealthRVAdapter( private val listener:HealthNewsItemClicked, private val btnlistener: ShareBtnClicked  ) : RecyclerView.Adapter<HealthRVAdapter.HealthViewHolder>(){
...
//        val cardView: CardView = itemView.findViewById(R.id.cardView)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HealthViewHolder {
        ...
        val viewHolder= HealthViewHolder(view)
...
interface HealthNewsItemClicked {

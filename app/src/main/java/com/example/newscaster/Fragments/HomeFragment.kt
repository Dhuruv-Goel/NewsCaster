...
import com.example.newscaster.RecyclerViewAdapter.HomeRVAdapter
import com.example.newscaster.RecyclerViewAdapter.NewsItemClicked
...
class HomeFragment : Fragment() ,NewsItemClicked,ShareBtnClicked{
...
private lateinit var shimmerView:ShimmerFrameLayout
    override fun onCreateView(
       ...
       adapter = HomeRVAdapter(this,this)
    ...
    private fun getNewsData() {
        RetrofitInstance.apiInterface.getNews(country,100,api).enqueue(object : retrofit2.Callback<mainNewsClass?> {

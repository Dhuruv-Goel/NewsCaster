...
class EntertainmentFragment : Fragment(), EnterNewsItemClicked,ShareBtnClicked{
    private lateinit var arrayList: ArrayList<NewsDataClass>
    private lateinit var adapter: EnterRVAdapter
    ...
    override fun onCreateView(
        ...
        recyclerView = view.findViewById(R.id.rventer)
        shimmerView = view.findViewById(R.id.shimmer_view_container_E)
        arrayList =ArrayList()
        recyclerView.layoutManager = LinearLayoutManager(context)
        adapter = EnterRVAdapter(this,this)

...
import com.example.newscaster.RecyclerViewAdapter.HealthNewsItemClicked
import com.example.newscaster.RecyclerViewAdapter.HealthRVAdapter
...
class HealthFragment : Fragment(),HealthNewsItemClicked ,ShareBtnClicked{
    private lateinit var arrayList: ArrayList<NewsDataClass>
    private lateinit var adapter: HealthRVAdapter
    ...
    override fun onCreateView(
        ...
        adapter = HealthRVAdapter(this,this)

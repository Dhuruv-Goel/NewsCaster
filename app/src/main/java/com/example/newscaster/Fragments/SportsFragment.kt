...
import com.example.newscaster.RecyclerViewAdapter.SportsNewsItemClicked
import com.example.newscaster.RecyclerViewAdapter.SportsRVAdapter
...
class SportsFragment : Fragment(), SportsNewsItemClicked,ShareBtnClicked {
    private lateinit var arrayList: ArrayList<NewsDataClass>
    private lateinit var adapter: SportsRVAdapter
    ...
    override fun onCreateView(
        ...
        adapter = SportsRVAdapter(this,this)

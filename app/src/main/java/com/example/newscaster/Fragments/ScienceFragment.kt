...
import com.example.newscaster.RecyclerViewAdapter.ScienceNewsItemClicked
import com.example.newscaster.RecyclerViewAdapter.ScienceRVAdapter
import com.example.newscaster.RecyclerViewAdapter.ShareBtnClicked
...
class ScienceFragment : Fragment(),ScienceNewsItemClicked ,ShareBtnClicked{
    private lateinit var arrayList: ArrayList<NewsDataClass>
    private lateinit var adapter: ScienceRVAdapter
    ...
    override fun onCreateView(
        ...
        recyclerView = view.findViewById(R.id.rvscience)
        shimmerView = view.findViewById(R.id.shimmer_view_container)
        arrayList =ArrayList()
        recyclerView.layoutManager = LinearLayoutManager(context)
        adapter = ScienceRVAdapter(this,this)
